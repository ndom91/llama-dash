...
- **Proxy clients** — expose OpenAI/Anthropic-compatible `/v1/*` endpoints plus native llama.cpp `POST /infill` for local models, peers, direct upstreams, Claude Code, Continue, Open WebUI, and more.
