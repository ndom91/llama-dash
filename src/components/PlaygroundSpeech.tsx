    ...
    <section className="panel pg-modality-panel">
      ...
      <form className="pg-gen-form" onSubmit={handleSubmit}>
        <textarea
          ...
          placeholder={speech.model ? 'Enter text to convert to speech…' : 'Select a model first…'}
          value={speech.text}
        ...
        >
          ...
          {speech.loading ? 'generating…' : 'generate'}
        </button>
      </form>
      ...
      {!speech.loading && !speech.audioUrl && !speech.error ? (
